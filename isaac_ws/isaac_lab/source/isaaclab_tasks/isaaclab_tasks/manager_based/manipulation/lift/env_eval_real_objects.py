...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    object4: RigidObjectCfg | DeformableObjectCfg = MISSING
    object5: RigidObjectCfg | DeformableObjectCfg = MISSING
    object6: RigidObjectCfg | DeformableObjectCfg = MISSING
...
class EventCfg:
    ...
    reset_object6_position = EventTerm(
        func=mdp.reset_root_state_uniform,
        mode="reset",
        # params=MISSING 
        params={
            "pose_range": {"x": (0.0, 0.0), "y": (0.0, 0.0), "z": (0.0, 0.0)}, # OBJECT POSE -> CUBE
            "velocity_range": {},
            "asset_cfg": SceneEntityCfg("object6", body_names="Object6"),
        },
    )
